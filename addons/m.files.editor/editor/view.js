define([
    ...
    var FilesTabView = monolith.require("views/files/tab");
    var FileSync = monolith.require("utils/filesync");
    var user = monolith.require("core/user");
    ...
    var themes = monolith.require("core/themes");
    var box = monolith.require("core/box");
    var collaborators = monolith.require("core/collaborators");
    var keyboard = monolith.require("utils/keyboard");
